...
let getData = async () => {
  ...
  renderHeadphoneData(data.headphone);
  renderLaptopData(data.laptop);
  renderGamingConsoleData(data.gaming);
  }catch(error){
...
let renderMobileData = (data) => {
  let mobileProducts = document.querySelector(".mobileProducts");
  mobileProducts.innerHTML = null;
  data.forEach((ele) => {
    mobileProducts.append(div(ele));
  });
};

let renderHeadphoneData = (data) => {
  let headphoneProducts = document.querySelector(".headphoneProducts");
  headphoneProducts.innerHTML = null;
  data.forEach((ele) => {
    headphoneProducts.append(div(ele));
  });
};

let renderLaptopData = (data) => {
  let laptopProducts = document.querySelector(".laptopProducts");
  laptopProducts.innerHTML = null;
  data.forEach((ele) => {
    laptopProducts.append(div(ele));
  });
};

let renderGamingConsoleData = (data) => {
  let gamingConsoleProducts = document.querySelector(".gamingConsoleProducts");
  gamingConsoleProducts.innerHTML = null
  data.forEach((ele) => {
    gamingConsoleProducts.append(div(ele));
  });
};
