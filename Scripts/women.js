...
let renderWomenData = (data) => {
  let products = document.querySelector(".womenProducts");
...
document.getElementById("sortLH").addEventListener("click", () => {
  let sortedLH = womenDataArr.sort((a, b) => a.deal_price - b.deal_price);
  renderWomenData(sortedLH);
});
document.getElementById("sortHL").addEventListener("click", () => {
  let sortedHL = womenDataArr.sort((a, b) => b.deal_price - a.deal_price);
  renderWomenData(sortedHL);
});
...
category1.addEventListener("click", () => {
  let filtered = womenDataArr.filter((ele) => {
    return ele.category === category1.innerText;
  });
  renderWomenData(filtered);
});
