...
let products = document.querySelector(".accessoriesProducts");
...
document.getElementById("sortLH").addEventListener("click", () => {
  let sortedLH = accessoriesDataArr.sort((a, b) => a.deal_price - b.deal_price);
  renderAccessoriesData(sortedLH);
});
document.getElementById("sortHL").addEventListener("click", () => {
  let sortedHL = accessoriesDataArr.sort((a, b) => b.deal_price - a.deal_price);
  renderAccessoriesData(sortedHL);
});
...
category1.addEventListener("click", () => {
  let filtered = accessoriesDataArr.filter((ele) => {
    return ele.category === category1.innerText;
  });
  renderAccessoriesData(filtered);
});
